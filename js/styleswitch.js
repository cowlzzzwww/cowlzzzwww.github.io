...
var styleswitcherstr = ' \
    ...
    <div class="switcher-box"> \
		...
		<a id="Gold" class="styleswitch color"></a> \
		<a id="Magenta" class="styleswitch color"></a> \
		<a id="orange" class="styleswitch color"></a> \
		<a id="DarkKhaki" class="styleswitch color"></a> \
		<a id="DarkRed" class="styleswitch color"></a> \
                <a id="DarkMagenta" class="styleswitch color"></a> \
		<a id="Red" class="styleswitch color"></a> \
		<a id="RoyalBlue" class="styleswitch color"></a> \
		<a id="YellowGreen" class="styleswitch color"></a> \
...
$(document).ready(function($){
    ...
    $("#summersky").click( function(){ $
    changeLayout('summersky');
    });
    $("#Gold").click( function(){ $
    changeLayout('Gold');
    });
    ...
    changeLayout('Magenta');
    });
    $("#orange").click( function(){ $
    changeLayout('orange');
    });
    $("#DarkKhaki").click( function(){ $
    changeLayout('DarkKhaki');
    });
    $("#DarkMagenta").click( function(){ $
    changeLayout('DarkMagenta');
    });
    $("#Red").click( function(){ $
    changeLayout('Red');
    });
    $("#RoyalBlue").click( function(){ $
    changeLayout('RoyalBlue');
    });
    $("#YellowGreen").click( function(){ $
    changeLayout('YellowGreen');
    });
